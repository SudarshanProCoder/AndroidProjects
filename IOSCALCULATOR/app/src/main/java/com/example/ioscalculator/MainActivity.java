...
public class MainActivity extends AppCompatActivity {
        ...
        b_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    if (!ifReallyDecimal()) {
                        t2.setText(val1 + "+");
                        b_add.setTextColor(Color.WHITE);
                    } else {
                        b_add.setTextColor(Color.WHITE);
                        t2.setText((int) val1 + "+");
                    }
        ...
        b_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    if (t1.getText().length() > 0)
                        if (!ifReallyDecimal()) {
                            b_sub.setTextColor(Color.WHITE);
                            t2.setText(val1 + "-");
                        } else {
                            b_sub.setTextColor(Color.WHITE);
                            t2.setText((int) val1 + "-");
        ...
        b_multi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    operation();
                    if (!ifReallyDecimal()) {
                        b_multi.setTextColor(Color.WHITE);
                        t2.setText(val1 + "×");
                    } else {
                        b_multi.setTextColor(Color.WHITE);
                        t2.setText((int) val1 + "×");
        ...
        b_divide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    operation();
                    if (ifReallyDecimal()) {
                        b_divide.setTextColor(Color.WHITE);
        ...
        b_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    t1.setText(String.valueOf((int) val1));
                    t2.setText(null);
                } else {
                    t2.setText("Error");
                }
    ...
    private void viewSetup() {
        ...
        b_add = findViewById(R.id.btnaddition);
        b_sub = findViewById(R.id.minus);
        b_clear = findViewById(R.id.ac);
        b_dot = findViewById(R.id.btnDot);
        b_para1 = findViewById(R.id.module);
        b_para2 = findViewById(R.id.action);
